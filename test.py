...
pretrained_model = AutoModelForCausalLM.from_pretrained("/root/autodl-tmp/meta-llama/Llama-3.2-3B").half()
...
model.save_pretrained("/root/autodl-tmp/Explicit-Memory/model/m3_llama_3.2_3b")
